...
MYSQL_PASSWORD=${osmng_setup_generate_passwords.os_mysql_keystone_password}

# Keystone definitions
KEYSTONE_REGION=RegionOne
SERVICE_TOKEN=${osmng_setup_generate_passwords.os_keystone_token}
SERVICE_ENDPOINT="http://${osmng_config.os_bind_address}:35357/v2.0"

# other definitions
MASTER="${osmng_config.os_bind_address}"
